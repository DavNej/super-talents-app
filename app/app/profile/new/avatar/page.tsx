...
import { Button, Loader, BackLink, ImagePreview } from '@/app/app/components'
import { useCreateAvatars } from '@/lib/avatar/hooks'
import { DataUrlType } from '@/lib/avatar/types'

const UploadFile = dynamic(() => import('@/app/app/components/UploadFile'), {
  ssr: false,
})
